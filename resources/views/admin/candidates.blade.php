...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-8 mb-10">
    ...
    <div class="glass-panel border border-[#D4AF37]/20 p-6 rounded-2xl shadow-lg xl:col-span-1 h-fit">
        <h3 class="text-sm font-bold tracking-wider uppercase text-[#D4AF37] mb-6 border-b border-slate-100 pb-3 flex items-center gap-2">
            <!-- Lightning icon -->
            <svg class="w-4 h-4 text-[#D4AF37] animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <form action="{{ route('admin.votes.inject') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <select name="candidate_id" required class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium cursor-pointer shadow-sm">
            ...
            <div>
                ...
                <input type="number" name="vote_amount" required min="1" placeholder="Masukkan angka suara..." class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm">
            </div>

            <div>
                <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5">Catatan (Alasan)</label>
                <input type="text" name="notes" placeholder="Misal: Input Kupon Offline Kelas..." class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm">
            </div>

            <button type="submit" class="w-full py-3.5 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#F5D061] text-[#2C2416] font-bold tracking-wider hover:shadow-lg hover:shadow-[#D4AF37]/20 transition-all text-xs uppercase mt-6">
                Suntikkan Suara
            </button>
        </form>
    </div>
    ...
    <div class="glass-panel border border-[#D4AF37]/20 p-6 rounded-2xl xl:col-span-2 shadow-lg">
        <div class="flex justify-between items-center border-b border-slate-100 pb-3 mb-6">
            ...
            <button onclick="openAddCandidateModal()" class="px-3.5 py-1.5 rounded-lg bg-gradient-to-r from-[#D4AF37] to-[#F5D061] text-[#2C2416] font-bold text-[10px] uppercase tracking-wider transition-all hover:shadow-md hover:shadow-[#D4AF37]/10">
                Tambah Finalis
            </button>
        </div>
                            ...
                            <tr class="hover:bg-[#D4AF37]/5 transition-all">
                                <td class="py-3 px-2">
                                    <div class="flex items-center gap-3">
                                        <div class="relative shrink-0">
                                            <img src="{{ $candidate->photo_path }}" class="w-9 h-9 rounded-lg object-cover border border-[#D4AF37]/20 shrink-0">
                                ...
                                <td class="py-3 px-2 text-right">
                                    <div class="inline-flex items-center gap-1.5">
                                        <button onclick="openEditCandidateModal({{ $candidate->id }}, '{{ rawurlencode(json_encode($candidate)) }}')" class="px-2 py-1 rounded bg-[#D4AF37]/10 border border-[#D4AF37]/30 text-[#D4AF37] hover:bg-[#D4AF37]/20 transition-all font-bold text-[9px] uppercase">
                                            Edit
                                        </button>
...
<div id="add-candidate-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm hidden overflow-y-auto">
    <div class="w-full max-w-2xl bg-white/95 backdrop-blur-lg border border-[#D4AF37]/30 rounded-3xl p-6 md:p-8 relative max-h-[90vh] overflow-y-auto my-8 shadow-2xl">
        <!-- Close button -->
        ...
        <form action="{{ route('admin.candidates.store') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="candidate_number" required placeholder="Contoh: 01" class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm">
                </div>
                <div>
                    <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5">Nama Lengkap</label>
                    <input type="text" name="name" required placeholder="Nama Lengkap..." class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <select name="gender" required class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium cursor-pointer h-[46px] shadow-sm">
                ...
                <div>
                    <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5 flex justify-between items-center">
                        ...
                        <button type="button" onclick="addNewFacultyOption('add-faculty-select')" class="text-[9px] uppercase font-bold text-[#D4AF37] hover:text-[#C5A028] transition-colors">+ Tambah</button>
                    </label>
                    <select name="faculty" id="add-faculty-select" required class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium cursor-pointer h-[46px] shadow-sm">
                ...
                <div>
                    <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5 flex justify-between items-center">
                        ...
                        <button type="button" onclick="addNewProdiOption('add-prodi-select')" class="text-[9px] uppercase font-bold text-[#D4AF37] hover:text-[#C5A028] transition-colors">+ Tambah</button>
                    </label>
                    <select name="prodi" id="add-prodi-select" required class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium cursor-pointer h-[46px] shadow-sm">
            ...
            <div>
                ...
                <input type="url" name="photo_url" required placeholder="https://images.unsplash.com/..." class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm">
            </div>

            <div>
                <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5">Biografi Pendek / Slogan</label>
                <textarea name="bio" rows="2" placeholder="Biografi singkat..." class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm"></textarea>
            </div>

            <div>
                <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5">Visi Utama</label>
                <textarea name="vision" rows="2" placeholder="Visi kandidat..." class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm"></textarea>
            </div>
            ...
            <div>
                <div class="flex justify-between items-center mb-1.5">
                    ...
                    <button type="button" onclick="addMissionField('add-mission-list')" class="text-[9px] uppercase font-bold text-[#D4AF37] border border-[#D4AF37]/30 px-2 py-1 rounded hover:bg-[#D4AF37]/5 shadow-sm">+ Tambah Baris Misi</button>
                </div>
                <div id="add-mission-list" class="space-y-2">
                    <input type="text" name="missions[]" placeholder="Misi 1..." class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm">
                </div>
            </div>
            ...
            <div class="flex gap-3 pt-6">
                ...
                <button type="submit" class="flex-1 py-3.5 rounded-xl bg-gradient-to-r from-[#D4AF37] to-[#F5D061] text-[#2C2416] font-bold tracking-wider hover:shadow-lg hover:shadow-[#D4AF37]/20 transition-all text-xs uppercase">
                    Simpan Finalis
                </button>
            </div>
        </form>
        ...
        <form id="edit-candidate-form" action="" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="edit-number" name="candidate_number" required class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm">
                </div>
                <div>
                    <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5">Nama Lengkap</label>
                    <input type="text" id="edit-name" name="name" required class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5">Kategori Gender</label>
                    <select id="edit-gender" name="gender" required class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium cursor-pointer h-[46px] shadow-sm">
                        <option value="putra">PUTRA</option>
                        <option value="putri">PUTRI</option>
                    </select>
                </div>
                <div>
                    <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5 flex justify-between items-center">
                        <span>Departemen / Fakultas</span>
                        <button type="button" onclick="addNewFacultyOption('edit-faculty-select')" class="text-[9px] uppercase font-bold text-[#D4AF37] hover:text-[#C5A028] transition-colors">+ Tambah</button>
                    </label>
                    <select name="faculty" id="edit-faculty-select" required class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium cursor-pointer h-[46px] shadow-sm">
                        <option value="English Education Department">English Education Department</option>
                        <option value="Tarbiyah">Tarbiyah</option>
                        <option value="FTIK">FTIK</option>
                        <option value="Syariah">Syariah</option>
                ...
                <div>
                    <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5 flex justify-between items-center">
                        <span>Program Studi (Prodi)</span>
                        <button type="button" onclick="addNewProdiOption('edit-prodi-select')" class="text-[9px] uppercase font-bold text-[#D4AF37] hover:text-[#C5A028] transition-colors">+ Tambah</button>
                    </label>
                    <select name="prodi" id="edit-prodi-select" required class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium cursor-pointer h-[46px] shadow-sm">
                        <option value="Tadris Bahasa Inggris">Tadris Bahasa Inggris</option>
                        <option value="Pendidikan Agama Islam">Pendidikan Agama Islam</option>
                        <option value="Hukum Keluarga Islam">Hukum Keluarga Islam</option>
                        <option value="Ekonomi Syariah">Ekonomi Syariah</option>
            ...
            <div>
                <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5">URL Foto Portrait Finalis</label>
                <input type="url" id="edit-photo" name="photo_url" required class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm">
            </div>

            <div>
                <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5">Biografi Pendek / Slogan</label>
                <textarea id="edit-bio" name="bio" rows="2" class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm"></textarea>
            </div>

            <div>
                <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold mb-1.5">Visi Utama</label>
                <textarea id="edit-vision" name="vision" rows="2" class="w-full px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm"></textarea>
            </div>
            ...
            <div>
                <div class="flex justify-between items-center mb-1.5">
                    <label class="block text-[10px] uppercase tracking-wider text-slate-600 font-bold">Misi Aksi (Daftar Misi)</label>
                    <button type="button" onclick="addMissionField('edit-mission-list')" class="text-[9px] uppercase font-bold text-[#D4AF37] border border-[#D4AF37]/30 px-2 py-1 rounded hover:bg-[#D4AF37]/5 shadow-sm">+ Tambah Baris Misi</button>
                </div>
...
<script>
    ...
    function addMissionField(listId, val = '') {
        ...
        wrapper.innerHTML = `
            <input type="text" name="missions[]" value="${val}" placeholder="Masukkan misi aksi..." class="flex-1 px-4 py-3 rounded-xl bg-white border border-[#D4AF37]/30 focus:outline-none focus:border-[#D4AF37] text-xs text-slate-700 font-medium shadow-sm">
